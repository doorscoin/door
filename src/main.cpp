...
const string strMessageMagic = "DoorsCoin Signed Message:\n";
  ...
  if(pindexBest->nHeight+1 >= 1 && pindexBest->nHeight+1 <= 10)
{
  ...
  else if(pindexBest->nHeight+1 >= 11 && pindexBest->nHeight+1 <= 1075010)
{
  nSubsidy = 800 * COIN;
}
  else if(pindexBest->nHeight+1 >= 1075011 && pindexBest->nHeight+1 <= 3225010)
{
  nSubsidy = 400 * COIN;
}
...
// DoorsCoin: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "DoorsCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xa1dc0804fe1f097b95841a2f7c1500e59127b8618590eb3049389308a4e977bc"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xa7, 0xa1, 0xc6, 0xf4 };
